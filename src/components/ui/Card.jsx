...
function Card({ item }) {
  return (
    <div className='my-8 rounded bg-white shadow-lg duration-300 hover:-translate-y-1'>
      <img src={item.image} alt='shop image' className='rounded-t h-72 w-full object-cover' />
